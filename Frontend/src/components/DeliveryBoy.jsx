          ...
          <div className="p-4 sm:p-5 lg:p-6">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-3">
              <div className="border border-gray-200 rounded-xl px-3 py-3 sm:px-4 sm:py-3.5">
                ...
                <p className="text-sm sm:text-base lg:text-lg font-bold text-[#172b4d] mt-1">20.294378</p>
              </div>
              <div className="border border-gray-200 rounded-xl px-3 py-3 sm:px-4 sm:py-3.5">
                <p className="text-[10px] sm:text-xs text-gray-500">Longitude</p>
                <p className="text-sm sm:text-base lg:text-lg font-bold text-[#172b4d] mt-1">85.744668</p>
              </div>
            </div>
